...
import { Traces, Trace, ServiceInstanceOption, searchEndpoints } from '../fragments/trace';
...
export const serchEndpoints = `query queryEndpoints(${searchEndpoints.variable}) {${searchEndpoints.query}}`;
