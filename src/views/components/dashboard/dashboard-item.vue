  ...
  <div class="dashboard-item" :class="`g-sm-${i.w}`" :style="`height:${i.h}px;`"
    ...
    <div class="dashboard-item-body">
      <div style="height:100%;">
        <component :type="i.t" :title="i.t" :is="rocketGlobal.edit ? 'ChartEdit' : i.c" ref="chart" :i="i" :index="index" :intervalTime="intervalTime" :data="rocketDashboard[i.d]"></component>
      </div>
    </div>
  </div>
</template>
